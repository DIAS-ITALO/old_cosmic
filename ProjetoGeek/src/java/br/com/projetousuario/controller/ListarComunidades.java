...
@WebServlet(name = "ListarComunidades", urlPatterns = {"/ListarComunidades"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            try {
                ...
                request.getRequestDispatcher("listarcomunidades.jsp").forward(request, response); // mandando os clientes para a JSP
            } catch (Exception e) {
