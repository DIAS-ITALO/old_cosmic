    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                request.setAttribute("usuarios", dao.listar()); // chamando o método listar
                request.getRequestDispatcher("listarusuarios.jsp").forward(request, response); // mandando os clientes para a JSP
                }catch(Exception e){
