...
public class ListarCategorias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("categorias", dao.listar()); // chamando o método listar
            request.getRequestDispatcher("listarcategorias.jsp").forward(request, response); // mandando as categorias para a JSP
        } catch (Exception e) {
            System.out.println("Problemas ao listar categorias! Erro: " + e.getMessage());
            e.printStackTrace();
        }
