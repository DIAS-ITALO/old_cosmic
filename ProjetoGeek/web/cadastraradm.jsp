    ...
    <body>
        ...
        <section>
            ...
            <div class="main-content">
                ...
                <form name="cadastraradm" action="CadastrarAdm" method="post">

                    <div class="campo-form">
                        <div class="group-form">
                            <img class="icon" src="assets/img/icon-user.png" />
                            <input type="text" name="nomeAdm" id="nome" placeholder="Nome">
                        </div>
                        
                        <div class="group-form">
                            <img class="icon" src="assets/img/icon-data.png" />
                            <input type="date" name="dataNascimentoAdm" id="data" placeholder="dd/dd/dddd">
                        </div>
                        <div class="group-form">
