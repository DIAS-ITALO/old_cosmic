...
%>
            <tr>
                ...
                <td align="center">
                    <a href="VerPaginaComunidade?idComunidade=<%=comunidade.getIdComunidade()%>"><%=comunidade.getNomeComunidade()%></a>
                </td>
            ...
            %>
            <tr>
                <th colspan="5"><a href="LogarUsuario?emailUsuario=${usuario.emailUsuario}&senhaUsuario=${usuario.senhaUsuario}">Voltar</a></th>
            </tr>
        </table>
    </body>
</html>
